...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const connect = useCallback(async (signal?: { cancelled: boolean }): Promise<() => void> => {
    ...
    try {
      ...
      if (!existingProfile) await repository.saveProfile({ id: session.user.id, displayName: null, bio: null, avatarPreset: 'orbit', interfaceLanguage: 'en', challengeShowName: false, shareRealStance: false })
