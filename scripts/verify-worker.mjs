...
if (health?.aiMode !== 'sideshift-ai') throw new Error('Worker health did not report sideshift-ai mode.')
if (!health?.ai?.provider) throw new Error('Worker health did not report an AI provider.')
